...
export default function Hero() {
    return (
        <section className="relative w-full flex flex-col items-center justify-center space-y-5 py-10 px-2">

            <div className='w-full lg:max-w-[750px] space-y-4'>
                <div className='flex justify-center gap-1 lg:gap-3 bg-giddaa-500/20 text-giddaa-500 rounded-full px-3 py-2 text-[10px] w-fit mx-auto font-semibold'>
                ...
                <div className='space-y-4'>
                    <h1 className="leading-[48px] lg:leading-[60px] text-[48px] font-bold text-center">Find a Home to Buy In Nigeria On Various <span className='text-giddaa-500'>Purchase Plans.</span></h1>
